    ...
    <div>
      ...
      {role === "SUP" ? (
        <div className="mid-content">
          ...
          <form onSubmit={handlerSubmitRMS} className="infoForm-content">
            <input
        ...
        <div className="mid-content">
          <h1>Manufacturers:</h1>
          <form onSubmit={handlerSubmitMAN} className="infoForm-content">
            <input
              className="form-control-sm"
              type="text"
        ...
        <div className="mid-content">
          <h1>Distributors:</h1>
          <form onSubmit={handlerSubmitDIS} className="infoForm-content">
            <input
              className="form-control-sm"
              type="text"
        ...
        <div className="mid-content">
          <h1>Retailers:</h1>
          <form onSubmit={handlerSubmitRET} className="infoForm-content">
            <input
              className="form-control-sm"
              type="text"
